...
public class DateUtil {
    ...
    public static final DateTimeFormatter YMD_FORMATTER = new DateTimeFormatterBuilder().appendPattern(YMD_STR).parseDefaulting(ChronoField.HOUR_OF_DAY, 0).parseDefaulting(ChronoField.MINUTE_OF_HOUR, 0).parseDefaulting(ChronoField.SECOND_OF_MINUTE, 0).toFormatter();
    public static final DateTimeFormatter YM_FORMATTER = new DateTimeFormatterBuilder().appendPattern(YM_STR).parseDefaulting(ChronoField.DAY_OF_MONTH, 1).parseDefaulting(ChronoField.HOUR_OF_DAY, 0).parseDefaulting(ChronoField.MINUTE_OF_HOUR, 0).parseDefaulting(ChronoField.SECOND_OF_MINUTE, 0).toFormatter();
